#pragma once
#include "../../D2Structs.h"
//#define MAX_SAVEFILESIZE 0x40000  //PlugY里面是0x4000
#define MAX_SAVEFILESIZE 0x4000  //PlugY里面是0x4000
//#define PCPY ((PYPlayerData*)((DWORD)ptChar->ptPlayerData+0x16C)) //PYPlayerData*->ptPYPlayerData
//PlugY里面是用0x49
#define PCPY49 ((PYPlayerData*)((DWORD)ptChar->ptPlayerData+0x49)) //PYPlayerData*->ptPYPlayerData
